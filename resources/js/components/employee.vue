<template>
	...
	<div class="container p-5">
		...
		<button type="button" class="btn btn-primary mb-4 float-right" data-toggle="modal" data-target="#myModal" @click="formReset">New Student</button>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						<h5 class="modal-title text-muted">Add New Student</h5>
